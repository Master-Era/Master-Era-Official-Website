    ...
    <section class="contact-section">
        ...
        <div class="contact-form-box">
            ...
            <?php if (($_GET['status'] ?? '') === 'success'): ?>
                <p class="form-status form-status-success" role="status">Thank you. Your inquiry has been sent successfully.</p>
            <?php elseif (($_GET['status'] ?? '') === 'invalid'): ?>
                <p class="form-status form-status-error" role="alert">Please complete all required fields with a valid email address.</p>
            <?php elseif (($_GET['status'] ?? '') === 'error'): ?>
                <p class="form-status form-status-error" role="alert">We could not send your inquiry. Please try again shortly.</p>
            <?php endif; ?>
